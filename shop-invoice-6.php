...
<!-- Mirrored from nest-frontend-v6.netlify.app/shop-invoice-6 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 28 Jun 2024 08:18:10 GMT -->
                        ...
                        <div class="invoice-info" id="invoice_wrapper">
                            <div class="invoice-header">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-6">
                                        <div class="logo">
                                            <a class='mr-20' href='index.html'><img src="assets/imgs/theme/logo.svg" alt="logo" /></a>
                                        </div>
                                    </div>
                                ...
                                <div class="row mt-20">
                                    ...
                                    <div class="col-lg-4">
                                        <strong class="text-brand"> Invoice No:</strong> 789654
                                    </div>
                                    <div class="col-lg-4">
                                        <strong class="text-brand"> Issue Date:</strong> 20 April, 2024
                                    </div>
                                    <div class="col-lg-4">
                                        <strong class="text-brand"> Payment Method:</strong> Credit Card
                                    </div>
                                    <div class="col-12">
                            ...
                            <div class="invoice-bottom pb-80">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <p class="font-sm">
                                            <strong>Issue date:</strong> 20 march, 2024<br />
...
<!-- Mirrored from nest-frontend-v6.netlify.app/shop-invoice-6 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 28 Jun 2024 08:18:11 GMT -->
</html>